...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/05/03 18:20:32 by lumorale          #+#    #+#             */
/*   Updated: 2023/05/08 11:16:55 by lumorale         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Account::~Account(void) {
	_accountIndex = _nbAccounts - 8;
	_nbAccounts++;
	std::cout << _accountIndex << "ESTOY AQUI" << _amount;
	this->_displayTimestamp();
	std::cout << "index:" << _accountIndex << ";"
		<< "amount:" << _amount << ";"
		<< "closed" << std::endl;
...
bool	Account::makeWithdrawal(int withdrawal) {
	...
	_amount -= withdrawal;
	std::cout << "amount" << _nbDeposits << std::endl;
	return true;
}

/* int	main(void)
{
	std::cout << "probamos cocitaz" << std::endl;
	pruba();
	std::cout << std::endl;
	return 0;
} */